...
public class LeerDD implements InOut {
	...
	public List<List<String>> leerDDEscenario(String hoja, String archivo) throws Exception {
		List<List<String>> data = new ArrayList<List<String>>();
		List<String> reg = null;
