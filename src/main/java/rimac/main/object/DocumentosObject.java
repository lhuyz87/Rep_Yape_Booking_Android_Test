...
public class DocumentosObject extends BaseScreen{
	
	// singleton
	private static DocumentosObject obj = null;

	private DocumentosObject() {
	}

	public static DocumentosObject getInstancia() {
		instanciar();
		return obj;
	}
